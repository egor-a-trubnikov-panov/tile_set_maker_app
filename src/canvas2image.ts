...
const Canvas2Image = (function () {
    ...
    function genImage(strData: string): HTMLImageElement {
     ...
     */
    const saveAsImage = function (canvas: HTMLCanvasElement | string, width: number, height: number, type: string, fileName: string): void {
        // save file type
        const fileType = type;
    ...
    const convertToImage = function (canvas: HTMLCanvasElement | string, width: number, height: number, type: string): HTMLImageElement {
        if ($support.canvas && $support.dataURL) {
            if (typeof canvas == "string") {
                canvas = document.getElementById(canvas) as HTMLCanvasElement;
            }
    ...
    return {
        ...
        saveAsPNG: function (canvas: HTMLCanvasElement, width: number, height: number, fileName: string) {
            return saveAsImage(canvas, width, height, "png", fileName);
        },
        saveAsJPEG: function (canvas: HTMLCanvasElement, width: number, height: number, fileName: string) {
            return saveAsImage(canvas, width, height, "jpeg", fileName);
        },
        saveAsGIF: function (canvas: HTMLCanvasElement, width: number, height: number, fileName: string) {
            return saveAsImage(canvas, width, height, "gif", fileName);
        },
        saveAsBMP: function (canvas: HTMLCanvasElement, width: number, height: number, fileName: string) {
            return saveAsImage(canvas, width, height, "bmp", fileName);
        },

        convertToImage: convertToImage,
        convertToPNG: function (canvas: HTMLCanvasElement, width: number, height: number): HTMLImageElement {
            return convertToImage(canvas, width, height, "png");
        },
        convertToJPEG: function (canvas: HTMLCanvasElement, width: number, height: number): HTMLImageElement {
            return convertToImage(canvas, width, height, "jpeg");
        },
        convertToGIF: function (canvas: HTMLCanvasElement, width: number, height: number): HTMLImageElement {
            return convertToImage(canvas, width, height, "gif");
        },
        convertToBMP: function (canvas: HTMLCanvasElement, width: number, height: number): HTMLImageElement {
